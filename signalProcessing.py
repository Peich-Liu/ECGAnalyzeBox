...
def filter_signal(cba_instance, lowcut_entry, highcut_entry, canvas_frame):
    if cba_instance.selected_channel_signal is None:
    ...
    filtered_signal = bandpass_filter(cba_instance.selected_channel_signal, lowcut, highcut, sampling_rate=cba_instance.fs)
...
# ====================================================================== 
def create_signal_processing_page(notebook, filter_command, artifact_command):
